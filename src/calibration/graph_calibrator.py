...
class ETS(nn.Module):
    ...
    def fit(self, train_dataloader, test_dataloader, wdecay):
        ...
        # one_hot = torch.nn.functional.one_hot(train_labels, num_classes=self.num_classes).long() 
        one_hot = torch.nn.functional.one_hot(train_labels, num_classes=train_labels.max().int() + 1).long() 
